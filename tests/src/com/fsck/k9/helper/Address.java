...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.kmail.mail.Address[] addresses =  com.kmail.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.kmail.mail.Address[] addresses =  com.kmail.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.kmail.mail.Address[] addresses =  com.kmail.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
