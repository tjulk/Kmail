...
public class SleepService extends CoreService {
    ...
    private static String ALARM_FIRED = "com.kmail.service.SleepService.ALARM_FIRED";
    private static String LATCH_ID = "com.kmail.service.SleepService.LATCH_ID_EXTRA";
    ...
    public static void sleep(Context context, long sleepTime, TracingWakeLock wakeLock, long wakeLockTimeout) {
        ...
        Intent i = new Intent();
        i.setClassName(context.getPackageName(), "com.kmail.service.SleepService");
