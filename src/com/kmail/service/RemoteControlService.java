...
import com.kmail.K9.BACKGROUND_OPS;
import com.kmail.remotecontrol.K9RemoteControl;

import static com.kmail.remotecontrol.K9RemoteControl.*;
...
public class RemoteControlService extends CoreService {
    private final static String RESCHEDULE_ACTION = "com.kmail.service.RemoteControlService.RESCHEDULE_ACTION";
    private final static String PUSH_RESTART_ACTION = "com.kmail.service.RemoteControlService.PUSH_RESTART_ACTION";

    private final static String SET_ACTION = "com.kmail.service.RemoteControlService.SET_ACTION";
            ...
            execute(getApplication(), new Runnable() {
                public void run() {
                    try {
                        ...
                        if (needsReschedule) {
                            Intent i = new Intent();
                            i.setClassName(getApplication().getPackageName(), "com.kmail.service.RemoteControlService");
