...
import com.kmail.Account.FolderMode;
import com.kmail.controller.MessagingController;
import com.kmail.mail.Pusher;

public class MailService extends CoreService {
    private static final String ACTION_CHECK_MAIL = "com.kmail.intent.action.MAIL_SERVICE_WAKEUP";
    private static final String ACTION_RESET = "com.kmail.intent.action.MAIL_SERVICE_RESET";
    private static final String ACTION_RESCHEDULE_POLL = "com.kmail.intent.action.MAIL_SERVICE_RESCHEDULE_POLL";
    private static final String ACTION_CANCEL = "com.kmail.intent.action.MAIL_SERVICE_CANCEL";
    private static final String ACTION_REFRESH_PUSHERS = "com.kmail.intent.action.MAIL_SERVICE_REFRESH_PUSHERS";
    private static final String ACTION_RESTART_PUSHERS = "com.kmail.intent.action.MAIL_SERVICE_RESTART_PUSHERS";
    private static final String CONNECTIVITY_CHANGE = "com.kmail.intent.action.MAIL_SERVICE_CONNECTIVITY_CHANGE";
    private static final String CANCEL_CONNECTIVITY_NOTICE = "com.kmail.intent.action.MAIL_SERVICE_CANCEL_CONNECTIVITY_NOTICE";
    ...
    private void cancel() {
        Intent i = new Intent();
        i.setClassName(getApplication().getPackageName(), "com.kmail.service.MailService");
