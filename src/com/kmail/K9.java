...
import com.kmail.R;
import com.kmail.Account.SortType;
import com.kmail.activity.MessageCompose;
...
import com.kmail.mail.internet.BinaryTempFileBody;
import com.kmail.provider.UnreadWidgetProvider;
import com.kmail.service.BootReceiver;
import com.kmail.service.MailService;
import com.kmail.service.ShutdownReceiver;
import com.kmail.service.StorageGoneReceiver;
...
public class K9 extends Application {
    ...
    public static class Intents {
        ...
        public static class EmailReceived {
            public static final String ACTION_EMAIL_RECEIVED    = "com.kmail.intent.action.EMAIL_RECEIVED";
            public static final String ACTION_EMAIL_DELETED     = "com.kmail.intent.action.EMAIL_DELETED";
            public static final String ACTION_REFRESH_OBSERVER  = "com.kmail.intent.action.REFRESH_OBSERVER";
            public static final String EXTRA_ACCOUNT            = "com.kmail.intent.extra.ACCOUNT";
            public static final String EXTRA_FOLDER             = "com.kmail.intent.extra.FOLDER";
            public static final String EXTRA_SENT_DATE          = "com.kmail.intent.extra.SENT_DATE";
            public static final String EXTRA_FROM               = "com.kmail.intent.extra.FROM";
            public static final String EXTRA_TO                 = "com.kmail.intent.extra.TO";
            public static final String EXTRA_CC                 = "com.kmail.intent.extra.CC";
            public static final String EXTRA_BCC                = "com.kmail.intent.extra.BCC";
            public static final String EXTRA_SUBJECT            = "com.kmail.intent.extra.SUBJECT";
            public static final String EXTRA_FROM_SELF          = "com.kmail.intent.extra.FROM_SELF";
        }

        public static class Share {
            /*
             * We don't want to use EmailReceived.EXTRA_FROM ("com.kmail.intent.extra.FROM")
             * because of different semantics (String array vs. string with comma separated
             * email addresses)
             */
            public static final String EXTRA_FROM               = "com.kmail.intent.extra.SENDER";
        }
    }
